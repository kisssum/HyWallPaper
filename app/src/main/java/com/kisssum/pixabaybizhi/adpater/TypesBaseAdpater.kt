...
class TypesBaseAdpater(private val context: Context, private val viewModel: TypesViewModel) :
    RecyclerView.Adapter<TypesBaseAdpater.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        // list
        val adapters = TypesAdpater(context, position + 1, true, isLargeImg = true)
